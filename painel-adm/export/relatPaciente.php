...
<head>
    ...
    <title>Relatório de Atendimento <?php echo date("d/m", strtotime($dadosAtendimento["Data_Inicio"])); ?> - <?php echo $dadosPaciente["Nome"]; ?></title>
</head>
<?php
@session_start();
...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-7">
            <h2>Paciente: <?php echo $dadosPaciente["Nome"]; ?></h2>
            <h3>Gênero: <?php echo $dadosPaciente["Genero"]; ?></h3>
            <h3>Convênio: <?php echo $dadosConvenio["Nome"]; ?></h3>
        </div>
        <div class="col-md-3">
            <?php
...
?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10">
                    <h1>Atendimento - <?php echo $dataInicio; ?></h1>
                    <h2><?php echo $horaInicio . " - " . $horaFim; ?></h2>
                </div>
                <div class="col-md-2">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-12">
                    ...
                    <textarea class="form-control auto-resize" id="Motivo" readonly name="Motivo"><?php echo $dadosAtendimento['Motivo']; ?></textarea>
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" id="Valor" name="Valor" class="form-control" readonly placeholder="Valor do Atendimento" value="<?php echo $dadosAtendimento['Valor']; ?>">
                    </div>
                    ...
                    <label for="OBS">OBS.</label>
                                <textarea rows="4" class="form-control auto-resize" readonly id="OBS" name="OBS"><?php echo $dadosAtendimento['OBS']; ?></textarea>

                </div>
                <div class="col-md-8">
                    <label for="Registro">Registro:</label>
                    <textarea class="form-control auto-resize" id="Registro" readonly rows="10" name="Registro"><?php echo $dadosAtendimento['Registro']; ?></textarea>
                </div>
            </div>
        </div>
        <br>
