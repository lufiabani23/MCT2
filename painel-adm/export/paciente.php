...
<body>
      ...
      <div class="row mt-4">
        <div class="col-2">
          ...
          if (isset($dadosPaciente[0]["Foto"])) { ?>
            ...
            <img src="../<?php echo $dadosPaciente[0]["Foto"] ?>" alt="Foto Atual" width="200em"
        ...
        <div class="col-8 ">
          <h1 class="text-center mt-5">RELATÓRIO DE PACIENTE</h1>
        </div>
        <div class="col-2">
          <img class="relatorio" src="../../img/logosistemapsico.png">
        </div>
      </div>
    </div>
  ...
  <button class="d-print-none btn btn-primary mb-5 mt-2 ml-2" onclick="window.close()"><i class="bi bi-arrow-left"></i> Clique aqui para retornar ao sistema</button>

  <div class="container">
    <div id="formModalPaciente" enctype="multipart/form-data">
      ...
      <div class="form-row">
        <div class="form-group col-md-6 col-sm-12">
          ...
          <input type="text" class="form-control" id="Telefone" name="Telefone" placeholder="Telefone do Paciente"
            value="<?php if (isset($dadosPaciente[0]["Telefone"])) {
      ...
      <div class="form-row">
        <div class="form-group col-md-12 col-sm-12">
          ...
          <input id="Endereco" name="Endereco" type="text" placeholder="Endereço do Paciente" class="form-control"
            value="<?php if (isset($dadosPaciente[0]["Endereco"])) {
      ...
      <div class="form-row">
        <div class="form-group col-md-12 col-sm-12">
          ...
          <textarea id="Prontuario" class="form-control" rows="7" name="Prontuario"
            placeholder="Prontuário do Paciente"><?php if (isset($dadosPaciente[0]["Prontuario"])) {
              echo $dadosPaciente[0]["Prontuario"];
            } ?></textarea>
        </div>
      </div>
